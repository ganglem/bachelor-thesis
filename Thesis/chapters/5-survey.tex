...
received the highest score, as expected. Similarly, \nameref{fig:architecture10} was expected to score high, 
as it is similar to \nameref{fig:architecture3} regarding the placement of external interfaces, but
