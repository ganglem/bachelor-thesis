...
The goal of \acrshort{autosar} is to create and establish an open and standardized software architecture for automotive \acrshort{ecu}s that is scalable to different vehicle and platform variants, 
...
\acrlong{tara} is an essential process for ensuring the cybersecurity of systems and networks, especially in the automotive industry. 
...
In addition, it can help prioritize these threats and vulnerabilities based on their potential impact on safety, financial, operational, and privacy aspects.\par
...
It is a great candidate as a framework for automotive risk assessments over traditional IT risk assessment models.\par
The \acrshort{evita} framework, which essentially performs the same things as \acrshort{heavens}, 
...
The model is based on the \acrshort{efsm}, with nodes representing attacker privileges and transitions representing a vulnerability.
...
The proposed attack feasibility rating concept is based on the attack-potential approach due to the complex nature of attacks against electric vehicles.\par
