...
In this thesis we will explore \nameref{chp:criteria} that can be used to evaluate the security of vehicular network architectures and how they can be used to automate the process of security testing.\\
These criteria are based on the experience of security experts and the results of a \nameref{sec:survey} conducted by the author of this thesis.
