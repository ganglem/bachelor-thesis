...
However, due to further factors used in this thesis, this thesis will also refer to the term of \textit{security feasibility}.
This term is used to describe the rating of a component to be secure, i.e. the likelihood of an attack is unsuccessful.
